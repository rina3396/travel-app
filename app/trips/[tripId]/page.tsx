  ...
  return (
    <section className="space-y-4 p-4">
      ...
      <ul className="list-disc pl-5 space-y-1">
        <li><Link className="underline" href={`/trips/${tripId}/preview`}>プレビュー</Link></li>
        <li><Link className="underline" href={`/trips/${tripId}/days`}>日別しおり編集</Link></li>
        <li><Link className="underline" href={`/trips/${tripId}/activities`}>アクティビティ（一覧/詳細）</Link></li>
        ...
        <li><Link className="underline" href={`/trips/${tripId}/share`}>共有/公開</Link></li>
        <li><Link className="underline" href={`/trips/${tripId}/settings`}>設定</Link></li>
      </ul>
    </section>
  )
}
